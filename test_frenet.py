...
fig = make_subplots()
fig.add_scatter3d(x=pos[:,0],y=pos[:,1],z=pos[:,2], mode ='lines', marker_color= 'black')
...
for i in range(len(t)):
	fig.add_scatter3d(x=[pos[i,0],pos[i,0]+vx[i,0]],y=[pos[i,1],pos[i,1]+vx[i,1]],z=[pos[i,2],pos[i,2]+vx[i,2]], mode ='lines', marker_color = 'red')
	fig.add_scatter3d(x=[pos[i,0],pos[i,0]+force1x[i,0]],y=[pos[i,1],pos[i,1]+force1x[i,1]],z=[pos[i,2],pos[i,2]+force1x[i,2]], mode ='lines', marker_color = 'blue')
	fig.add_scatter3d(x=[pos[i,0],pos[i,0]+B[i,0]],y=[pos[i,1],pos[i,1]+B[i,1]],z=[pos[i,2],pos[i,2]+B[i,2]], mode ='lines', marker_color = 'green')
