...
for i in range((len(B[0]))):
	fig.add_scatter3d(x=[r[0][i],r[0][i]+T[0][i]],y=[r[1][i],r[1][i]+T[1][i]],z=[r[2][i],r[2][i]+T[2][i]], mode ='lines', marker_color = 'red')
	fig.add_scatter3d(x=[r[0][i],r[0][i]+N[0][i]],y=[r[1][i],r[1][i]+N[1][i]],z=[r[2][i],r[2][i]+N[2][i]], mode ='lines', marker_color = 'green')
	fig.add_scatter3d(x=[r[0][i],r[0][i]+B[0][i]],y=[r[1][i],r[1][i]+B[1][i]],z=[r[2][i],r[2][i]+B[2][i]], mode ='lines', marker_color = 'blue')
